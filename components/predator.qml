...
Image {
    ...
    //In DNA
    property int viewarea: 100 * page.scale // Radius of the area in wich the animal will find food, ect
    ...
    property real maxspeed: 4 * page.scale // Max Walking speed
    property real minspeed: 1 * page.scale // Min Walking Speed
    ...
    property int eatarea: 20 * page.scale // Radius of the area in wich food can be eaten
    ...
    function tick(){
                ...
                if(page.animals[i].alive){ // Exclude dead animals
                    ...
                    if(dist < viewarea && dist > 0){
                        if(dist < (15*page.scale)){
                            ...
                            searching = true;
                            searcher.start();
                            xytodirection(page.animals[i].x + (50 * page.scale), page.animals[i].y);
                        }
                    }
                }
            }
        ...
        if(moving){
            ...
            else if(absy > rect.height - (45*page.scale)){
                absy = rect.height -(45*page.scale);
                randomdirection();
            }
